...
const TypographyFont = ['primary'] as const;
    ...
    return (
      <Component
        ...
        className={clsxm(
          //#region  //*=========== Variants ===========
          [
            variant === 'j1' && ['font-primary text-4xl font-bold'],
            variant === 'j2' && ['font-primary text-3xl font-bold'],
            variant === 'h1' && ['font-primary text-5xl  font-bold'],
            variant === 'h2' && ['font-primary text-3xl font-semibold'],
            variant === 'h3' && ['font-primary text-xl font-semibold'],
            variant === 'h4' && ['font-primary text-base font-bold'],
            variant === 'h5' && ['font-primary text-base font-semibold'],
            variant === 'h6' && ['font-primary text-sm font-semibold'],
            variant === 's1' && ['font-primary text-xl font-medium'],
          ...
          //#region  //*=========== Color ===========
          [
            color === 'primary' && ['text-primary-light'],
            color === 'secondary' && ['text-secondary-slate'],
